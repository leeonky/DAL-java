...
public class CucumberContext {
    ...
    private static final Map<String, NodeMatcher<DALRuntimeContext, DALNode, DALExpression, DALOperator,
        ...
        put("dot-property", compiler.DOT_PROPERTY_C.defaultInputNode(InputNode.INSTANCE));
        put("identity-property", compiler.IDENTITY_PROPERTY);
        put("bracket-property", compiler.BRACKET_PROPERTY_C.defaultInputNode(InputNode.INSTANCE));
        put("explicit-property", compiler.EXPLICIT_PROPERTY_C.defaultInputNode(InputNode.INSTANCE));
        put("property", compiler.PROPERTY);
        put("operand", optional(compiler.OPERAND));
        put("binary-operator-expression", compiler.BINARY_OPERATOR_EXPRESSION_C.defaultInputNode(InputNode.INSTANCE));
        put("schema-expression", compiler.SCHEMA_EXPRESSION_C.defaultInputNode(InputNode.INSTANCE));
