...
class ClosingBraceTokenFactoryTest extends TokenFactoryTestBase {

    @Override
    protected TokenFactory createTokenFactory() {
        return TokenFactory.createClosingBraceTokenFactory();
    }

    @Override
    protected Token createToken(Object value) {
        return Token.closingBraceToken();
    }
    ...
    void return_token_when_matches_code() {
        assertThat(parseToken("}")).isEqualTo(Token.closingBraceToken());
    }
