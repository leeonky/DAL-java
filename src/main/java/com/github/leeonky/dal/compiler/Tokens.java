...
public class Tokens {
    public static final TokenScanner<RuntimeContextBuilder.DALRuntimeContext, DALNode, DALExpression, DALOperator, DALParser>
    ...
    public static final OperatorParser.Mandatory<RuntimeContextBuilder.DALRuntimeContext, DALNode, DALExpression, DALOperator,
            DALParser>
            DEFAULT_JUDGEMENT_OPERATOR = scanner -> scanner.currentOperator().orElseGet(DALOperator.Matcher::new);
}
